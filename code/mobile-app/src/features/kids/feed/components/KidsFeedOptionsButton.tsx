/**
 * KidsFeedOptionsButton Component
 * Floating options button with mute and auto-advance toggles.
 * Ported from the main feed's FeedOptionsButton with Kids color palette.
 */
...
interface KidsFeedOptionsButtonProps {
  isMuted: boolean;
  autoAdvance: boolean;
  onToggleMute: () => void;
...
export const KidsFeedOptionsButton: React.FC<KidsFeedOptionsButtonProps> = ({
  isMuted,
  autoAdvance,
  onToggleMute,
  onToggleAutoAdvance,
...
const styles = StyleSheet.create({
  ...
  statusBadge: {
    ...
    height: 28,
    borderRadius: 14,
    backgroundColor: `${kidsColors.primary}CC`,
    justifyContent: 'center',
    alignItems: 'center',
  },
  modalOverlay: {
