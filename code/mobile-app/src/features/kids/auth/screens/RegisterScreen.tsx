...
const styles = StyleSheet.create({
  safeRoot: { flex: 1, backgroundColor: kidsColors.background },
  ...
  backButton: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', marginBottom: 8, padding: 8, minHeight: 44 },
  backArrow: { fontSize: 20, fontWeight: '700', color: kidsColors.primary, marginRight: 4 },
  backText: { fontSize: 16, fontWeight: '600', color: kidsColors.primary },
