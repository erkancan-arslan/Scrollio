...
export const mockVideos: Video[] = [
  ...
  },
  {
    ...
    description: 'How plants turn sunlight into energy — quick explainer for busy learners.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    thumbnailUrl: 'https://picsum.photos/seed/plants/400/700',
    duration: 60,
    creator: {
      id: 'c9',
      username: 'bio_brief',
      displayName: 'Bio Brief',
      avatarUrl: 'https://i.pravatar.cc/150?u=bio9',
      isVerified: false,
    },
    stats: {
      views: 41000,
  ...
  {
    id: '10',
    title: 'Intro to the water cycle',
    description: 'Evaporation, condensation, precipitation — the loop that keeps Earth hydrated.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
    thumbnailUrl: 'https://picsum.photos/seed/watercycle/400/700',
    duration: 55,
    creator: {
      id: 'c10',
      username: 'earth_bits',
      displayName: 'Earth Bits',
      avatarUrl: 'https://i.pravatar.cc/150?u=earth10',
      isVerified: true,
    },
    stats: {
      views: 88000,
    ...
    topic: 'Earth Science',
    topicId: null,
    tags: ['water', 'weather', 'environment'],
    difficulty: 'beginner',
