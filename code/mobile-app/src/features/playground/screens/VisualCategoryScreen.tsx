...
type VisualCategoryScreenProps = {
    navigation: NativeStackNavigationProp<RootStackParamList, 'VisualCategory'>;
};
...
const GAMES = [
    {
        id: 'zoom_focus',
        name: 'Zoom & Focus',
        description: 'Guess the zoomed-in object.',
        icon: 'scan-outline',
        route: 'ZoomFocus',
        isReady: true
    },
    {
        id: 'perfect_eye',
        name: 'Perfect Eye',
        description: 'Match the exact color.',
...
export const VisualCategoryScreen: React.FC<VisualCategoryScreenProps> = ({ navigation }) => {
    return (
