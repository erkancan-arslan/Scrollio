    ...
    useEffect(() => {
        if (visible) {
            ...
            Animated.parallel([
                ...
                Animated.spring(cardSlideAnim, { toValue: 0, tension: 90, friction: 10, useNativeDriver: true }),
            ]).start();
    ...
    return (
        <Animated.View style={[styles.overlay, { opacity: fadeAnim }]}>
            ...
            >
                ...
                <Text style={styles.deskName}>{deskName}</Text>
...
const styles = StyleSheet.create({
    ...
    winnerBox: { backgroundColor: 'rgba(255,255,255,0.08)' },
    scoreLabel: { fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.8 },
    scoreValue: { fontSize: 38, fontWeight: '900', color: '#FFFFFF', lineHeight: 44 },
    winnerScore: { fontSize: 42 },
    crownEmoji: { fontSize: 16, marginTop: 2 },
    scoreSub: { fontSize: 11, color: '#636366' },
    vsContainer: { width: 36, alignItems: 'center' },
    vs: { fontSize: 13, fontWeight: '900', color: '#48484A', letterSpacing: 1 },
    continueBtn: {
        borderRadius: 16,
        paddingVertical: 15,
