...
export const STEP_PROGRESS: Record<string, number> = {
  ...
  [JobStep.GENERATING_SCRIPT]: 20,
  [JobStep.CLEANING_NARRATION]: 25,
  [JobStep.GENERATING_TTS]: 40,
  [JobStep.GENERATING_LIPSYNC]: 60,
  [JobStep.COMPOSING_VIDEO]: 72,
  [JobStep.BURNING_SUBTITLES]: 82,
  [JobStep.GENERATING_THUMBNAIL]: 88,
